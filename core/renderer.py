...
PHRASE_PATTERNS = [
    ...
    (r'\bpanni vachikkitte\b', 'பண்ணி வச்சிக்கிட்டே', 'பண்ணி வச்சிக்கிட்டே'),
    (r'\bthookam than\b', 'தூக்கம் தான்', 'தூக்கம் தான்'),
]
...
WORD_PATTERNS = {
    ...
    "irunthuchu":("இருந்துச்சு", "இருந்துச்சு"),
    "aprom":     ("அப்றம்", "அப்றம்"),
    "vera":      ("வேற", "வேற"),
    "enna":      ("என்ன", "என்ன"),
    "panra":     ("பண்ற", "பண்ற"),
    ...
    "than":      ("தான்", "தான்"),
    "panni":     ("பண்ணி", "பண்ணி"),
    "vachikkitte":("வச்சிக்கிட்டே", "வச்சிக்கிட்டே"),
}
